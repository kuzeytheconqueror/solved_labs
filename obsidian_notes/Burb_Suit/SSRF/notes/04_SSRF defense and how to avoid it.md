...
Lab needs to be solved: https://portswigger.net/web-security/ssrf/lab-ssrf-with-blacklist-filter
...
Lab needs to be solved: https://portswigger.net/web-security/ssrf/lab-ssrf-with-whitelist-filter
...
Lab needs to be solved: https://portswigger.net/web-security/ssrf/lab-ssrf-filter-bypass-via-open-redirection
...
To read more: https://portswigger.net/web-security/ssrf/blind
