...
| Lab | Key Technique |
|---|---|
| [[Exploiting AI agents to perform destructive actions]] | Stored XSS / IDOR in a comment tricks the scanner into deleting `carlos` |
| [[Exploiting AI agents to exfiltrate sensitive information]] | Indirect prompt injection exfiltrates `carlos`'s API key |
